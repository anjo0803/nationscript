...
exports.create = root => new NSFactory()
	.onTag('AUCTIONS', me => me
		.build('auctions')
		.assignSubFactory(ArrayFactory.default('AUCTION', (me, attrs) => me
			.build('')
			.assignSubFactory(Auction.create(attrs)))))
	.onTag('COLLECTION', (me, attrs) => me
		.build('collectionDetail')
		.assignSubFactory(Collection.create(attrs)))
	.onTag('COLLECTIONS', me => me
		.build('collections')
		.assignSubFactory(ArrayFactory.default('COLLECTION', (me, attrs) => me
			.build('')
			.assignSubFactory(ListCollection.create(attrs)))))
	.onTag('DECK', me => me
		.build('cards')
	...
	.onTag('TRADES', me => me
		...
		.assignSubFactory(ArrayFactory.default('TRADE', (me, attrs) => me
			.build('')
			.assignSubFactory(Trade.create(attrs)))));
