...
/**
 * Legal shards to query with requests to the NationStates API.
 * @namespace shards
 */

/**
 * Valid shards to query in requests to the (individual) cards endpoint of the
 * API.
 * @memberof shards
 * @enum {string}
 */
const CardDetailShard = {
	...
	/** Get transfers of the card, whether by gift or auction. */
	TRADES: 'trades'
};

/**
 * Valid shards to query in requests to the (deck/world) cards endpoint of the
 * API.
 * 
 * **Note: Querying multiple at once can cause the request to load longer than
 * usual.**
 * @memberof shards
 * @enum {string}
 */
const CardShard = {
	/** Get current asks and bids (markets) of a defined nation. */
	ASKS_BIDS: 'asksbids',

	/** Get currently ongoing auctions. */
	AUCTIONS: 'auctions',

	/** Get the trading cards in the deck of a defined nation. */
	CARDS: 'deck',

	/** Get the trading cards in a defined collection. */
	COLLECTION_DETAILS: 'collection',

	/** Get the collections of a defined nation. */
	COLLECTIONS: 'collections',

	/** Get aggregate info on the deck of a defined nation. */
	DECK_SUMMARY: 'info',

	/** Get transfers of cards, whether by gift or auction. */
	TRADES: 'trades'
};
...
const NationShard = {
	...
	/** Get the percentage of the nation's GDP that is generated by government activity. */
